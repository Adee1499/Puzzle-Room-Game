...
public class tangram2 : MonoBehaviour
{
    ...
    void Start()
    {
        if (PlayerPrefs.GetInt("tangram2") == 1) Destroy(this.gameObject);
    }

    // Update is called once per frame
    void Update()
    {
        drawerOpen = CRTMonitor.GetComponent<StartHackGame>().drawerOpen;
